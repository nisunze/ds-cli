        ...
        serde_json::to_vec(&json!({
            ...
            "profiles": {
                "stable": {
                    ...
                    "design_versions": {"method":"POST","path":"/api/v1/design/versions","actions":["list_versions","get_version","get_head","create_version","restore_version","revise_version","freeze_version","list_version_events"]},
