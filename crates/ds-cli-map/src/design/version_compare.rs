...
pub static COMMAND: Command = Command {
    ...
    contract: 2,
    summary: "Open a visual comparison of retained desktop transformer versions.",
    purpose: "Open a desktop comparison of retained versions or the local head. The kernel supplies bounded counts and consistency findings; the comparison room is retained offline. No restore payload crosses the CLI. For headless published-history comparison use `ds design version compare`.",
