...
pub static LIST_COMMAND: Command = Command {
    ...
    examples: &[
        ...
        Example {
            command: "ds survey moments list --project <project-id> --form poles --since 2026-09-01 --sync waiting --output json",
            note: "Rotated pole photos of September still waiting to publish.",
            runnable: false,
        },
    ],
...
pub static READ_COMMAND: Command = Command {
    ...
    reference: Some("docs/reference/survey.md"),
    search: &["moment details", "photo info", "survey photo file"],
    requires: Requires::Server,
    availability: || ds_cli_contract::spec::Availability::Available,
};
