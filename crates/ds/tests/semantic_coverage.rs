...
const EXPECTED: &[(&str, &str, &str)] = &[
    ...
    ("server.tile.submit", "local_file_write", "headless_user"),
    ...
    ("design.project.revisions", "read_only", "none"),
    ...
    ("solar.portfolio.create", "global_write", "headless_project"),
    ("solar.portfolio.delete", "global_write", "headless_project"),
    ("solar.portfolio.export", "local_file_write", "desktop_user"),
    ("solar.portfolio.list", "read_only", "headless_project"),
    ("solar.portfolio.read", "read_only", "desktop_user"),
    ("solar.portfolio.update", "global_write", "headless_project"),
    ...
    ("style.seed.create", "global_write", "headless_project"),
    ...
    ("tile.global.catalog", "read_only", "desktop_user"),
    ("tile.global.generate", "global_write", "desktop_user"),
    ("tile.global.list", "read_only", "desktop_user"),
    ("tile.global.status", "read_only", "desktop_user"),
