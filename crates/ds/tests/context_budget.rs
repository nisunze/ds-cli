...
fn discovery_indexes_are_cheap_in_json() {
    ...
    // The native LV process adds one compact `design.lv.process` result to the same
    ...
    assert_within(
        ...
        // still capped and command prose remains below this tier. The native
        // LV process adds one more compact Design result to this same fixed
        // projection.
        //
