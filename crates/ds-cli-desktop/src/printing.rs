...
pub static EXPORT_COMMAND: Command = Command {
    ...
    output: "Explicit project and transformer, artifact count, exact filenames/formats/sizes/SHA-256/locators and recorded paper sizes, context warnings and cached layer feature counts, and publication state.",
    examples: &[],
    refusals: &[
        ops::NOT_PAIRED,
        ops::AMBIGUOUS,
