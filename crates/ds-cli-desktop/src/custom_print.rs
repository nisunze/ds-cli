...
pub fn export(inputs: &Inputs, _: &Context) -> Result<Value, Failure> {
    ...
    if !metadata.is_file() || metadata.len() > 800_000 {
        ...
        .remedy("For a held ds.print-layout-export/v1 capture use report.layout.render; this Desktop planner accepts administrative codes and a layout under 800,000 bytes"));
    }
