...
pub static EXPORT_COMMAND: Command = Command {
    ...
    args:&[Arg::value("request","<json-file>","Path to a JSON file containing project, id, family (custom-map or mv-map), codes (sector or district codes), paper (A3 or A0), optional authored layout, and DPI (default 300, range 72–1200).").required(),DESCRIPTOR_ARG],
