...
pub static COMMAND: Command = Command {
    ...
    contract: 1,
    summary: "Apply a previewed typed Solar report grouping.",
    purpose: "Echoes the preview plan digest; stale definitions, assignments or Solar inventory require re-preview.",
    ...
    output: "The applied solar_report grouping plan.",
    examples: &[],
