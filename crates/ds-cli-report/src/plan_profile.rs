...
pub static COMMAND: Command = Command {
    ...
    args: &[
        ...
        Arg::value(
            "ds-branding",
            "<on|off>",
            "Print the discrete DS GridDesign by datasolutions.rw margin credit.",
        )
        .default("on")
        .choices(&["on", "off"]),
        Arg::value(
