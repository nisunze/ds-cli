...
2. **DS Grid proposes, PLS-CADD confirms — until verified.** DS Grid's stringing, strength and clearance results are *proposals* with a verification level (contract 06). PLS-CADD 16.81 is the authority for delivery verdicts. A DS Grid receipt never presents a proposal as a verdict.
