...
|---|---|
| 00-charter | 01-B (2026-09-20) |
| 01-server-required | 01-B: §3 working copy in place, §5 receipts, §6 typed `structure describe|retype`, `report structures` |
| 04-structure-rules-spotting | 01-B: §1 angle-pole band (assumed), §5 structure list, refusals |
